...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { description: @todolist.description, pending: @todolist.pending, title: @todolist.title } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { description: @todolist.description, pending: @todolist.pending, title: @todolist.title } }
